...
```bash
curl -fsSL https://apt.dwdc.club/gpg.key | sudo gpg --dearmor -o /usr/share/keyrings/dwdc-archive-keyring.gpg

echo "deb [signed-by=/usr/share/keyrings/dwdc-archive-keyring.gpg] https://apt.dwdc.club stable main" \
